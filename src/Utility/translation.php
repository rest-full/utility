...
class translation
{
    ...
    public function __construct()
    {
        ...
        $this->search = $instance->resolveClass(
                $instance->assemblyClassOrPath('%s' . DS_REVERSE . 'Search' . DS_REVERSE . 'Search', [ROOT_NAMESPACE]),
    ...
    public function translate(string $text): string
    {
        ...
        return $this->getSentencesFromJSON($result);
    }
    ...
    {
        if (is_null($json)) {
            throw new Exceptions('This response not found.', 404);
        }
